...
// Placeholder public results page. The live leaderboard is not designed yet —
// this route reserves the URL and gives racers a clear "coming soon" landing.
// It intentionally has no data/backend dependency.
